  ...
  fields: [
...

    {
      ...
      fields: [
        ...
        { type: "string", name: "capabilitiesLabel", label: "Capabilities menu label" },
        {
          type: "object",
          name: "capabilities",
          ...
          fields: [
            { type: "string", name: "icon", label: "Font Awesome icon (e.g. fa-robot)" },
...

    {
      ...
      label: "Stats strip",
      list: true,
      ui: { itemProps: (item) => ({ label: `${item?.number ?? ""}${item?.suffix ?? ""} — ${item?.label ?? ""}` }) },
      fields: [
...

    {
      ...
      fields: [
        ...
        { type: "string", name: "lead", label: "Lead", ui: { component: "textarea" } },
        {
          ...
          fields: [
            { type: "string", name: "icon", label: "Font Awesome icon" },
            { type: "string", name: "stepLabel", label: "Step label (e.g. Step 01)" },
            { type: "string", name: "title", label: "Title" },
            { type: "string", name: "description", label: "Description", ui: { component: "textarea" } },
          ],
        },
      ...
      fields: [
        ...
        },
        {
          ...
          fields: [
            ...
            { type: "string", name: "avatarInitials", label: "Avatar initials" },
        ...
        },
        {
          ...
          fields: [
            { type: "string", name: "question", label: "Question" },
            {
              ...
              list: true,
              ui: { itemProps: (item) => ({ label: item?.text?.slice(0, 60) }) },
              fields: [{ type: "string", name: "text", label: "Paragraph", ui: { component: "textarea" } }],
            },
            { type: "boolean", name: "openByDefault", label: "Open by default" },
          ],
        },
      ],
    },
      ...
      fields: [
        ...
        { type: "string", name: "lead", label: "Lead", ui: { component: "textarea" } },
        {
          ...
          fields: [
            ...
            { type: "string", name: "submitIcon", label: "Submit icon (Font Awesome)" },
...

    {
      ...
      fields: [
        ...
        { type: "string", name: "builtWithName", label: "Built with name (e.g. TinaCMS)" },
